...
%o`, message, error2, detail);
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    function createInfoButtons() {
      ...
      infoTypesContainer.classList.add("container", "text-center");
      ...
      infoTypes.forEach((infoType) => {
        ...
        row.classList.add("row", "row-cols-2", "row-cols-lg-5", "g-2", "g-lg-3");
        infoTypesContainer.appendChild(row);
        const col = document.createElement("div");
        col.classList.add("col");
        row.appendChild(col);
        const infoButton = document.createElement("button");
        infoButton.classList.add("btn", "btn-primary", "p-3");
        infoButton.textContent = infoType;
        infoButton.addEventListener("click", () => {
          addInfoType(infoType);
        });
        col.append(infoButton);
      });
