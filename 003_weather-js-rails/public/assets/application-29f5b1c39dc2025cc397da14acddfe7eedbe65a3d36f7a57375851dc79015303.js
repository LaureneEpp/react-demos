...
%o`, message, error2, detail);
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    function addInfoType(infoButton, infoType) {
    ...
    function displaySelectedInfo() {
      ...
      selectedInfoTypes.forEach((infoType) => {
        ...
        if (infoText) {
          ...
          card_body.appendChild(infoElement);
        }
      });
      const infoContainers = document.createElement("div");
      infoContainers.classList.add("text-center");
      infoContainers.appendChild(selectedInfoContainer);
      weatherMoreInfoDisplay.innerHTML = "";
      weatherMoreInfoDisplay.appendChild(infoContainers);
    }
