...
%o`, message, error2, detail);
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const weatherDisplay2 = document.getElementById("weather-display");
    const weatherMoreInfoDisplay2 = document.getElementById(
    ...
    function displayWeather(data) {
      ...
      `;
      weatherDisplay2.innerHTML = weatherHtml;
      errorDisplay.textContent = "";
    ...
    function createInfoButtons() {
      ...
      weatherMoreInfoDisplay2.innerHTML = "";
      weatherMoreInfoDisplay2.append(infoTypesContainer);
    }
    ...
    function displaySelectedInfo() {
      ...
      weatherMoreInfoDisplay2.appendChild(selectedInfoContainer);
    }
