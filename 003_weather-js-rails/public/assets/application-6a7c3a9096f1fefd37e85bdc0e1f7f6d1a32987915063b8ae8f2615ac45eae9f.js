    ...
    function getInfoText(infoType) {
      switch (infoType) {
        case "Temperature min":
          return `<strong class="fw-semibold">Temperature min:</strong> ${weatherData.main.temp_min}\xB0C`;
        case "Temperature max":
          return `<strong class="fw-semibold">Temperature max:</strong> ${weatherData.main.temp_max}\xB0C`;
        case "Humidity":
          return `<strong class="fw-semibold">Humidity:</strong> ${weatherData.main.humidity}%`;
        case "Wind Speed":
          return `<strong class="fw-semibold">Wind Speed:</strong> ${weatherData.wind.speed} m/s`;
        case "Sunrise":
          return `<strong class="fw-semibold">Sunrise:</strong> ${new Date(
            weatherData.sys.sunrise * 1e3
          ).toLocaleTimeString()}`;
        case "Sunset":
          return `<strong class="fw-semibold">Sunset:</strong> ${new Date(
            weatherData.sys.sunset * 1e3
          ).toLocaleTimeString()}`;
        case "Pressure":
          return `<strong class="fw-semibold">Pressure:</strong> ${weatherData.main.pressure}`;
        case "Longitude":
          return `<strong class="fw-semibold">Longitude:</strong> ${weatherData.coord.lon}`;
        case "Latitude":
          return `<strong class="fw-semibold">Latitude:</strong> ${weatherData.coord.lat}`;
        case "Rain":
          return `<strong class="fw-semibold">Clouds:</strong> ${weatherData.clouds.all} %`;
        default:
          return "";
      }
    }
