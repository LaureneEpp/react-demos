  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("weather-form").addEventListener("submit", (event) => {
      ...
      if (!city) {
        ...
        errorDisplay.classList.add("error-popup");
        error_content = errorDisplay.createElement("div");
        error_content.classList.add("error-content");
        error_content.textContent = "Enter a correct city";
